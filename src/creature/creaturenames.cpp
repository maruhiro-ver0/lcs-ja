...
void firstname(char *str, char gender)
{
   ...
   "Ga'bor",   "Gabriel",   "Garett",   "Garreth",
   "Garth",   "Gary",   "George",   "Gerald",
   "Geraldo",   "Ge'za",   "Gilbert",   "Giovanni",
   "Glen",   "Glenn",   "Graham",   "Greg",
   "Gregory",   "Gus",   "Gustav",   "Guy",
   "Gyo:rgy",   "Gyula",   "Hafez",   "Hagar",
   ...
   "Samuel",   "Sander",   "Sa'ndor",   "Sanford",
   "Scott",   "Sea'n",   "Sebastian",   "Serge",
   ...
   "Mo'fsrag",   "Nadezhda",   "Nadia",   "Nadine",
